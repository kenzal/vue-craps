...
import type { MaxOdds } from '@/compostables/MaxOdds';
...
export const fnMaxOddsLightSide = function (
    this: BetSignatureCome | BetSignaturePassLine | BetSignaturePut | BetSignatureDontCome | BetSignatureDontPass,
): number {
...
export const fnMaxOddsDarkSide = function (this: BetSignatureDontCome | BetSignatureDontPass): number {
...
export interface BetSignatureBuy extends BetSignatureBasic, withOverride, withPlacement, withVig {
    type: BetType.BUY;
    placement: Placement;
}
...
export interface BetSignatureCome extends BetSignatureBasic, withOdds, withPlacement {
    type: BetType.COME;
}
...
export interface BetSignatureDontCome extends BetSignatureBasic, withOdds, withPlacement {
    type: BetType.DONT_COME;
}

export interface BetSignatureDontPass extends BetSignatureBasic, withOdds, withPlacement {
...
export interface BetSignatureHardway extends BetSignatureBasic, withPlacement, withOverride {
    type: BetType.HARDWAY;
    placement: PlacementHardways;
}
...
export interface BetSignatureLay extends BetSignatureBasic, withPlacement, withVig {
    type: BetType.LAY;
}

export interface BetSignaturePassLine extends BetSignatureBasic, withOdds, withPlacement {
    type: BetType.PASS_LINE;
}

export interface BetSignaturePlace extends BetSignatureBasic, withOverride, withPlacement {
    type: BetType.PLACE;
    placement: Placement;
}

export interface BetSignaturePut extends BetSignatureBasic, withOdds, withOverride, withPlacement {
    type: BetType.PUT;
    placement: Placement;
}
...
export function findBet(
    ...
    if (BetOptions[type].hasPlacement)
        return allOfType.filter((bet) => 'placement' in bet && bet.placement === placement).pop();
