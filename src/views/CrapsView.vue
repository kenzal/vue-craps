...
const previousResponse = JSON.parse('{"new_table":{"config":{},"puck_location":4,"existing_bets":[{"type":"PassLine","wager":5,"placement":4},{"type":"Come","wager":5,"placement":6,"odds":10},{"type":"Place","wager":5,"placement":4},{"type":"Place","wager":5,"placement":5},{"type":"Place","wager":6,"placement":6,"override_puck":"OFF"},{"type":"Place","wager":6,"placement":8},{"type":"Place","wager":5,"placement":9},{"type":"Place","wager":5,"placement":10},{"type":"Hop","wager":1,"placement":[1,3]},{"type":"AnySeven","wager":1}]}}');
...
<template>
  <div class="crapsTable">
    <craps-box
      ...
      :initial-bets="
        previousResponse.new_table.existing_bets.filter((bet) => bet.placement === Number(boxNum))
      "
      ref="boxes"
    />
    <div class="dont-come">
    ...
    <div class="self-serve">
      <bet-box :increment="increment" v-model="come">Come</bet-box>
      <bet-box :increment="increment" v-model="field">Field</bet-box>
      <bet-box :increment="increment" v-model="dontPass"
        >Don't Pass Bar 12</bet-box
      >
      <bet-box :increment="increment" v-model="pass">Pass</bet-box>
    </div>
  </div>
  <ul class="bet-select">
    <li
